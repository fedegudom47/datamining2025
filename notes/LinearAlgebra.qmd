...
# there's a slight miss-typo in the visualisation of the eigenvalue decomposition of A. The second matrix, $\lambda$, or the diagonal matrix of eigenvalues has $\lambda_2$ instead of $\lambda_r$.
